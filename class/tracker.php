...
class CPM_Tracker extends WeDevs_Insights {
    ...
    public function __construct() {
        ...
        $notice = __( 'Want to help make WP Project Manager even more awesome? Allow weDevs to collect non-sensitive diagnostic data and usage information. Enjoy 15 % discount on upgrades and add-on purchase.', 'cpm' );
