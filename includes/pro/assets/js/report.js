...
( function( $ ) {
    var report = {
        init: function() {
            $( '#cpm-advance-report' ).on( 'change', '.cpm-report-action', this.reportAction );
            $( '#cpm-advance-report' ).on( 'click', '.cpm-report-more', this.reportAddmore );
            $( '#cpm-advance-report' ).on( 'click', '.cpm-report-cross', this.cross );
        ...
        actionDropdown: function( $this ) {
            var action = $( '#cpm-advance-report .cpm-report-content' ).find( '.cpm-report-action-wrap' );
