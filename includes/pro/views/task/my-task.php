        ...
        <div class="cpm-row cpm-project-group">
            <ul class="cpm-col-10 cpm-my-task-menu">
                ...
                <li  class="<?php if ( $ctab == 'overview' ) echo 'active' ?>">
                    <a href="<?php echo cpm_url_my_task() ?>" class="cpm-my-taskoverview" data-item="overview" data-user="<?php echo $user_id ?>"><?php _e( 'Overview', 'cpm' ); ?><div></div></a>
                </li>
                <li class="<?php if ( $ctab == 'useractivity' ) echo 'active' ?>">
                    <a href="<?php echo cpm_url_user_activity(); ?>" class="cpm-my-taskactivity" data-item="activity" data-user="<?php echo $user_id ?>"><?php _e( 'Activity', 'cpm' ); ?><div></div></a>
                </li>

                <li class="<?php if ( $ctab == 'current' ) echo 'active' ?>">
                    <a href="<?php echo cpm_url_current_task(); ?>" data-item="current" data-user="<?php echo $user_id ?>" class="cpm-my-currenttask"><?php _e( 'Current Task', 'cpm' ); ?> <div ><?php echo $count[ __( 'Current', 'cpm' ) ]; ?></div></a>
                </li>

                <li class="<?php if ( $ctab == 'outstanding' ) echo 'active' ?>">
                    <a href="<?php echo cpm_url_outstanding_task(); ?>" data-item="outstanding" data-user="<?php echo $user_id ?>" class="cpm-my-outstandigntask"><?php _e( 'Outstanding Task', 'cpm' ); ?> <div><?php echo $count[ __( 'Outstanding', 'cpm' ) ]; ?></div></a>
                </li>
                <li class="<?php if ( $ctab == 'complete' ) echo 'active' ?>">
                    <a href="<?php echo cpm_url_complete_task(); ?>" data-item="complete" data-user="<?php echo $user_id ?>"  class="cpm-my-completetask"><?php _e( 'Completed Task', 'cpm' ); ?> <div ><?php echo $count[ __( 'Completed', 'cpm' ) ]; ?></div></a>
                </li>
            </ul>
