 ...
 *
 * Спецификация: docs/core/task-list.md
 */
class Task_List extends Project_Entity {

	const CPT = 'cpm_task_list';
...
";
	...
	/**
	 * ID вехи или -1, если веха не назначена.
	 *
	 * @var int
	 */
	public $milestone = -1;
	...
	/**
	 * @param array $args Данные сущности, включая milestone.
	 */
	public function __construct( $args = array() ) {
		parent::__construct( $args );
		$this->milestone = isset( $args['milestone'] ) ? (int) $args['milestone'] : -1;
	}
